      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
              ...
              return (
                ...
                >
                  ...
                  {item.id === 'budgets' && overBudgetCount > 0 && (
                    <span className="flex items-center justify-center w-5 h-5 text-xs font-extrabold bg-amber-400 text-slate-950 rounded-full ml-1 shadow-sm">
                      {overBudgetCount}
                    </span>
                  )}
                </button>
          ...
          <div className="flex items-center gap-2.5">
            ...
            {/* Dropdown CTA: + Add / Upload Statement */}
            <div className="relative" ref={dropdownRef}>
              <button
                onClick={() => setIsDropdownOpen((prev) => !prev)}
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-extrabold text-sm shadow-lg shadow-emerald-500/25 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
